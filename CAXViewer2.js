var nmfs = [ 
  ...
  {"mpop": 3,"esu": 6,"popname": "Steelhead (Snake River Basin DPS) - Clearwater River Lower Mainstem","popid": 303,"popcode": "STSNRsuCWL","cname": "Clearwater River Lower Mainstem","species": 5,"run": 5,locations: ["FallClearwater"]},
  ...
  {"mpop": 25,"esu": 9,"popname": "Chinook Salmon (Snake River Spring/Summer-run ESU) - Lochsa River","popid": 72,"popcode": "CKSNRssLCH","cname": "Lochsa River","species": 1,"run": 4,locations: ["Lochsa"]},
...
d3.csv("NOAA_SPS_Analysis.csv", function (_criteria) {
	...
	metadata = _metadata;
	Default = {};
	Default.plotted_range = [1945,2020];
	Current = {};
...
var juv_data = {"JTOTALNATURAL": [],"JAGE0PROP": [],"JAGE1PROP": [],"JAGE2PROP": [],"JAGE3PROP": [],"JAGE4PLUSPROP": [], ALLJUVS: []};
var pre_data = {"PABUNDANCE": [],"PAGE0PROP": [],"PAGE1PROP": [], ALLJUVS: []};
var meta_data = [];
...
var juv_vars = ["JTOTALNATURAL","JAGE0PROP","JAGE1PROP","JAGE2PROP","JAGE3PROP","JAGE4PLUSPROP"]
var pre_vars = ["PABUNDANCE","PAGE0PROP","PAGE1PROP"]
...
data.forEach(function (d) {
	...
	keys.forEach(function (dd) {
		...
		var alljuvs = {year: year, pop: dd, JTOTALNATURAL: "NA",JAGE0PROP: "NA",JAGE1PROP: "NA",JAGE2PROP: "NA",JAGE3PROP: "NA",JAGE4PLUSPROP: "NA"}
